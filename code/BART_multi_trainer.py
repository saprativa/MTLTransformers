...
class MultiTrainer:
    ...
    def __init__(
        ...
        data_collator_ex: Optional[DataCollator] = None,
        train_dataset: Optional[Dataset] = None,
        train_dataset_ex: Optional[Dataset] = None,
        ...
        self.data_collator_ex = data_collator_ex if data_collator_ex is not None else default_collator
        self.train_dataset_ex = train_dataset_ex
...
############################################################################################################    
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            optimizer_cls, optimizer_kwargs = MultiTrainer.get_optimizer_cls_and_kwargs(self.args)
    ...
    def _maybe_log_save_evaluate(self, tr_loss, model, trial, epoch, ignore_keys_for_eval):
        ...
        if self.control.should_evaluate:
            metrics = self.seq_evaluate(ignore_keys=ignore_keys_for_eval)
...
#################################################################################
    ...
    def evaluation_loop(
        ...
        for step, inputs in enumerate(dataloader):
            ...
            # Prediction step
            loss, logits, labels = self.seq_prediction_step(model, inputs, prediction_loss_only, ignore_keys=ignore_keys)
    ...
    def seq_evaluate(
        ...
        return self.evaluate(eval_dataset, ignore_keys=ignore_keys, metric_key_prefix=metric_key_prefix)


    def seq_prediction_step(
        self,
        model: nn.Module,
        inputs: Dict[str, Union[torch.Tensor, Any]],
        prediction_loss_only: bool,
